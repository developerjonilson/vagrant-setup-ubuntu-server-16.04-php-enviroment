Vagrant-Setup (Ubuntu-server - 16.04)
===========
...
- git clone https://github.com/especializati/vagrant-setup-ubuntu-16-04.git ( Execute o comando no seu Prompt/Terminal )
...
obs:(A senha padrão para todos os serviços é admin).
